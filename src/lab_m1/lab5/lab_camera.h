...
namespace implemented
{
    class Camera
    {
     public:
        ...
        Camera(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up, const float distanceToTarget)
        {
        ...
        // Update camera
        void Set(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up, const float distanceToTarget)
        {
