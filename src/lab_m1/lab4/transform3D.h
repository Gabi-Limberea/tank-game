...
namespace transform3D
{
    ...
    inline glm::mat4 RotateAroundOXLike(float radians, glm::vec3(point)) {
        return Translate(point.x, point.y, point.z) * RotateOX(radians) * Translate(-point.x, -point.y, -point.z);
    }
}   // namespace transform3D
